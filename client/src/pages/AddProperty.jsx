...
export default function AddProperty() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.imageUrls.length < 1)
        return setError('You must add at least one image');
  ...
  return (
    <main className='p-3 max-w-5xl mx-auto'>
        <h1 className='text-3xl font-semibold text-center my-7'>Add a new property</h1>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                <p className='font-semibold'>Images:
                  <span className='font-normal text-gray-600 ml-2'>You can upload upto 6 images</span>
                </p>
                <div className='flex gap-4'>
                    <input 
                      ...
                      multiple
                    />
                    <button type='button' disabled={uploading} onClick={handleImageSubmit} className='p-3 text-green-600 border border-green-600 rounded 
                ...
                <button disabled={loading || uploading} className='p-3 bg-indigo-800 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>

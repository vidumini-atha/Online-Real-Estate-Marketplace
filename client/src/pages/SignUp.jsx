    ...
    <div className='p-8 mt-20 mb-20 max-w-lg mx-auto border border-slate-400 bg-blue-100 rounded-lg shadow-lg'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <input 
          ...
          onChange={handleChange} 
        />
        <button disabled={loading} className='bg-indigo-800 text-white font-semibold p-3 rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{loading ? 'Loading...' : 'Sign Up'}</button>
        <OAuth/>
      </form>
